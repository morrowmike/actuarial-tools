...
# read in plan design
with open('https://github.com/morrowmike/actuarial-tools/design_test.txt') as f:
  design = json.load(f) 
# read in population
with open('https://github.com/morrowmike/actuarial-tools/pop_test.txt') as f:
  population = json.load(f) 
# read in av model claimant data
clmnt_df = pd.read_csv('https://github.com/morrowmike/actuarial-tools/AVSummarizedData.csv',index_col=0)
